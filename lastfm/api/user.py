...
def getFriends(method: str, api_key: typ.UUID, user: str = secret.user, recenttracks: int = 0, limit: int = 50, page: int = 1) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getInfo(method: str, api_key: typ.UUID, user: str = secret.user) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getLovedTracks(method: str, api_key: typ.UUID, user: str = secret.user, limit: int = 50, page: int = 1) -> typ.response:
...
def getPersonalTags(method: str, api_key: typ.UUID, tag: str, taggingtype: TaggingType, user: str = secret.user, limit: int = 50, page: int = 1) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getRecentTracks(method: str, api_key: typ.UUID, user: str = secret.user, FROM: typ.UnixTimestamp = None, to: typ.UnixTimestamp = None, limit: int = 50, page: int = 1, extended: int = 0) -> typ.response:
...
@param.required
@pydantic.validate_arguments(config=dict(use_enum_values=True))
def getTopAlbums(method: str, api_key: typ.UUID, user: str = secret.user, period: Period = None, limit: int = 50, page: int = 1) -> typ.response:
...
@param.required
@pydantic.validate_arguments(config=dict(use_enum_values=True))
def getTopArtists(method: str, api_key: typ.UUID, user: str = secret.user, period: Period = None, limit: int = 50, page: int = 1) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getTopTags(method: str, api_key: typ.UUID, user: str = secret.user, limit: int = 50) -> typ.response:
...
@param.required
@pydantic.validate_arguments(config=dict(use_enum_values=True))
def getTopTracks(method: str, api_key: typ.UUID, user: str = secret.user, period: Period = None, limit: int = 50, page: int = 1) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getWeeklyAlbumChart(method: str, api_key: typ.UUID, user: str = secret.user, FROM: typ.UnixTimestamp = None, to: typ.UnixTimestamp = None) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getWeeklyArtistChart(method: str, api_key: typ.UUID, user: str = secret.user, FROM: typ.UnixTimestamp = None, to: typ.UnixTimestamp = None) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getWeeklyTrackChart(method: str, api_key: typ.UUID, user: str = secret.user, FROM: typ.UnixTimestamp = None, to: typ.UnixTimestamp = None) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getWeeklyChartList(method: str, api_key: typ.UUID, user: str = secret.user) -> typ.response:
...
@param.required
@pydantic.validate_arguments
def getTrackScrobbles(method: str, api_key: typ.UUID, artist: str, track: str, user: str = secret.user, limit: int = 50, page: int = 1) -> typ.response:
