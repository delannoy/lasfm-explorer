...
def lookup(entity: str, mbid: uuid.UUID, inc: list[str] = None, sub_entity: str = '', type: list[str] = None, status: list[str] = None) -> awkward.Record:
    endpoint = f'/{entity}/{mbid}' if not sub_entity else f'/{entity}/{mbid}/{sub_entity}'
...
def collection(mbid: uuid.UUID, sub_entity: str = '', inc: list[str] = None) -> awkward.Record:
    return lookup(entity='collection', sub_entity=sub_entity, mbid=mbid, inc=inc)
